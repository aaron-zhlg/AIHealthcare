...
* :mod:`medresearch.literature`    — PubMed literature sub-agent.
* :mod:`medresearch.trials`        — ClinicalTrials.gov sub-agent.
* :mod:`medresearch.orchestrator`  — LeadResearcher + medical prompts.
...
Or run one sub-agent on its own::
    ...
    from medresearch import MedicalLiteratureAgent
...
from medresearch.literature import MedicalLiteratureAgent, PubMedTools, search_literature
from medresearch.orchestrator import (
    DEFAULT_MODEL,
    LeadResearcher,
    ResearchReport,
    deep_research,
...
from medresearch.trials import ClinicalTrialsAgent, ClinicalTrialsTools
